...
class Rectangle: public Point         //public inheritence of class Point by Rectangle class
{
  Point p1, p2, p3, p4;
  public:
    Rectangle(Point,Point);           //constructor with parameters
...
Rectangle::Rectangle()
{
  //assigning default values to points p1,p2,p3,p4
  p1.Set_X(0);
  p1.Set_Y(0);
...
Rectangle::Rectangle(Point a, Point b)
{
  p1 = a;
  p3 = b;
  //assigning coordinats to the other points on the rectangle
  p2.Set_X(p1.Get_X());
  p2.Set_Y(p3.Get_Y());
  ...
  //displaying the coordinates of the rectangle 
  cout<<"Coordinates of the points on the rectangle respectively from 1 to 4 are: "<<endl;
  p1.print();
  cout<<endl;
...
int Rectangle::side2()                 //defining private member function side2()
{
  l2 = p4.Get_X() - p1.Get_X();
}

int Rectangle::area()                  //defining public member function area()
{
  return l1*l2;
}
//defining side functions for the rectangle
...
//asks user the coordinates for 2 points using which a rectangle is to be made
  ...
  cout<<"Please enter the coordinates of 1st point"<<endl;
  ...
  Point p1(xval,yval);
  cout<<endl;
  cout<<"Please enter coordinates of 2nd point"<<endl;
  cout<<"x coordinate: "<<endl;
  cin>>xval;
  cout<<endl;
  cout<<"y coordinate: "<<endl;
...
//Lab 7 Exercises 4.2, 4.3. Testing of the class Rectangle goes here: 
  ...
  //Displaying coordinates of rectangle ob1
  cout<<"Rectangle ob1:"<<endl;
  Rectangle ob1;
  
  
  //Displaying coordinates of rectangle ob2
